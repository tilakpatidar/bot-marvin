...
*/
var Config = function(trigger_obj){
	...
	*/
	if(process.RUN_ENV === "TEST"){
		var config={"verbose":false, "logging": false}; //by default will get overidden once config is loaded from db 
	}else{
