...
function updateDbConfig(dic,fn){
		...
		pool.stats.updateConfig(gc('bot_name'),dic,function updateDbConfig_updateConfig(err,results){
...
function pullDbConfig(fn){
	pool.config_reloader.pullDbConfig(gc('bot_name'),function pullDbConfig_pullDbConfig(err,results){
...
function configReloader(){
		pullDbConfig(function configReloader_pullDbConfig(err,new_config){
...
exports.pullConfig=function pullConfig(fn){
	pullDbConfig(function pullDbConfig(err,results){
