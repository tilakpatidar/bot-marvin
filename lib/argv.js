...
exports.init=function(){
	...
	if(check.assigned(argv["init"])){
		process.reset=true;
        process.init=true;
	 	console.log("Downloading tika server please wait !");
		var file = fs.createWriteStream(__dirname+"/tika-server-1.11.jar");
		  var req = request("http://apache.spinellicreations.com/tika/tika-server-1.11.jar", function(response) {
