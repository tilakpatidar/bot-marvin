...
*/
var Bot = function(config_obj, pool_obj, cluster_obj, trigger_obj, logger_obj) {
                ...
                pool.bot.startBotAddNewBot(t, function startBotAddNewBot(err, result) {
                    ...
                    if (!err) {
                        ...
                        pool.bot.requestToBecomeMaster(config.getConfig("bot_name"), function(status) {
                            if (status) {
                                trigger.set('cluster_master',true);
                            } else {
                                trigger.set('cluster_master',false);
                            }
                            return fn(true);
                        });
